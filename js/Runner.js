(function() {
    ...
    Runner.defaultDimensions = {
        WIDTH: BASECONFIG.DEFAULT_WIDTH,
        HEIGHT: 150
    };
    ...
    Runner.prototype = {
        ...
        setSpeed: function(opt_speed) {
            ...
            if (this.dimensions.WIDTH < BASECONFIG.DEFAULT_WIDTH) {
            var mobileSpeed = speed * this.dimensions.WIDTH / BASECONFIG.DEFAULT_WIDTH *
        ...
        init: function() {
            ...
            this.canvasCtx.fillStyle = BASECONFIG.RUNNER_FILLSTYLE;
            this.canvasCtx.fill();
        ...
        adjustDimensions: function() {
            ...
            this.dimensions.WIDTH = Math.min(BASECONFIG.DEFAULT_WIDTH, this.dimensions.WIDTH);
            if (this.activated) {
        ...
        onKeyDown: function(e) {
            ...
            if (BASECONFIG.IS_MOBILE && this.playing) {
            e.preventDefault();
            }
        ...
        isArcadeMode: function() {
            return document.title == BASECONFIG.ARCADE_MODE_URL;
        },
